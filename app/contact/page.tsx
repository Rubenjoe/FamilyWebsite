        ...
        <div className="min-h-screen bg-[#fbf9f4] pb-24">
            ...
            <div className="bg-white border-b border-[#1b3622]/5 py-16 px-6">
                <div className="max-w-7xl mx-auto space-y-3 text-center">
                    ...
                    <p className="text-gray-600 font-normal max-w-xl mx-auto text-base leading-relaxed pt-2">
            ...
            <div className="max-w-6xl mx-auto px-6 mt-16 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-5 space-y-8">
                    <div className="space-y-2">
                        <h2 className="text-sm uppercase tracking-[0.15em] text-[#1b3622] font-bold border-b border-gray-100 pb-2">
                            Liaison Channels
                        </h2>
                    ...
                    <div className="bg-white border border-[#1b3622]/10 p-6 space-y-6 shadow-sm relative overflow-hidden">
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-sm uppercase tracking-[0.08em] font-semibold text-[#2d312e]">Ancestral Tharavadu</h3>
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-sm uppercase tracking-[0.08em] font-semibold text-[#2d312e]">Digital Correspondence</h3>
                                <p className="text-sm text-gray-700 font-normal leading-relaxed">
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-sm uppercase tracking-[0.08em] font-semibold text-[#2d312e]">Direct Telephony</h3>
                                <p className="text-sm text-gray-700 font-normal leading-relaxed font-mono">
                                    +91 487 2384 928 <br />
                                    +91 944 7289 104
                                </p>
                            </div>
                        ...
                        <div className="flex gap-4 items-start">
                            ...
                            <div className="space-y-1">
                                <h3 className="text-sm uppercase tracking-[0.08em] font-semibold text-[#2d312e]">Archive Hours</h3>
                                <p className="text-sm text-gray-700 font-normal leading-relaxed">
                    ...
                    <div className="bg-white/50 border border-dashed border-gray-200 p-6 rounded-sm space-y-2">
                        <h4 className="text-sm uppercase tracking-[0.08em] font-bold text-[#1b3622]">Response Window</h4>
                        <p className="text-sm text-gray-600 font-normal leading-relaxed">
                ...
                <div className="lg:col-span-7 bg-white border border-[#1b3622]/10 p-8 shadow-sm relative">
                    ...
                    <h2 className="text-sm uppercase tracking-[0.15em] text-[#1b3622] font-bold border-b border-gray-100 pb-3 mb-6 flex items-center gap-2">
                    ...
                    <AnimatePresence mode="wait">
                        {isSubmitted ? (
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-600 font-normal max-w-sm mx-auto leading-relaxed">
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center gap-2 border border-gray-200 text-gray-700 text-sm font-semibold uppercase tracking-[0.08em] px-6 py-2.5 hover:border-[#1b3622]/30 transition-colors mt-4"
                                >
                            ...
                            >
                                {/* Name Input */}
                                <div className="space-y-1">
                                    <label className="text-xs uppercase tracking-[0.08em] text-gray-500 block font-semibold">
                                        Your Full Name *
                                    </label>
                                    <input
                                        required
                                        ...
                                        className="w-full bg-[#fbf9f4] border border-gray-200 text-sm p-3 focus:outline-none focus:border-[#1b3622] text-[#2d312e]"
                                    />
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-[#fbf9f4] border border-gray-200 text-sm p-3 focus:outline-none focus:border-[#1b3622] text-[#2d312e] resize-none"
                                    />
                                </div>
                                ...
                                <motion.button
                                    ...
                                    disabled={isLoading}
                                    type="submit"
                                    className="w-full bg-[#1b3622] text-[#fbf9f4] py-3.5 text-sm uppercase tracking-[0.1em] font-semibold hover:bg-[#d4af37] hover:text-[#1b3622] transition-colors duration-300 flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
                                >
                                    {isLoading ? (
